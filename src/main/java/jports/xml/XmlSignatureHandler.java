...
import jports.security.X509CertificateKeySelector;
import jports.security.X509CertificateWithKey;
...
public class XmlSignatureHandler {
	...
	public synchronized void sign()
		...
		if (this.document == null)
			throw new ShowStopper("Can't sign a NULL document");
	...
	public synchronized boolean validate()
		...
		if (list.getLength() == 0) {
			throw new ShowStopper("Cannot find Signature element");
		}
